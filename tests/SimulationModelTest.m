...
classdef SimulationModelTest < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function testSimulateFunction(testCase)
            ...
            % testCase.verifyEqual(height(testCase.model.SimDataTable), ...
            %     sum(testCase.model.SimDataTable.Dose > 0));
        end
        ...
        function testROIsBetweenThresholds(testCase)
            ...
            roiStatus = testCase.model.ROIsBetweenThresholds;
            testCase.verifyTrue(roiStatus);
        end
    end
end